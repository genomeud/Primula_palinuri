...
# plot(result$He_ratio,result$snp_ratio,xlab="Log10(Heterozygous SNPs / Informative SNPs)",ylab="Log10(Informative SNPs / Total SNPs)",pch=21,las=1,cex=0.6, col="black",bg=result$color, main="Heterozygosity Ratio") 
